--[[
    LUAWARE HUB V1 - THE TRUE HAWK REPLICA
    YAPIMCI: NOXYORJ
    Tasarım: Birebir Orijinal (Kırmızı çizgiler yok, düz antrasit/gri, orijinal boyut)
]]
...
-- ============================================
local Theme = {
    Main = Color3.fromRGB(25, 25, 25),       -- Orijinal Kapkaranlık Arka Plan
    TopLine = Color3.fromRGB(45, 45, 45),    -- Üst barın altındaki ince gri çizgi
    TabActive = Color3.fromRGB(45, 45, 45),  -- Seçili sekmenin gri arka planı
    Text = Color3.fromRGB(255, 255, 255),    -- Saf beyaz
    SubText = Color3.fromRGB(180, 180, 180), -- Gri alt metin
    RedText = Color3.fromRGB(255, 80, 80)    -- Xeno yazısı için kırmızı
}

-- Pürüzsüz Kaydırma Motoru
...
Main.Size = UDim2.new(0, 520, 0, 320) -- BİREBİR ORİJİNAL KOMPAKT BOYUT
...
Title.BackgroundTransparency = 1; Title.Text = "Hawk HUB"
...
WelcomeTitle.Text = "Welcome to Hawk HUB"
...
DisplayName.Text = "Noxy"; DisplayName.TextColor3 = Theme.Text; DisplayName.Font = Enum.Font.GothamBold; DisplayName.TextSize = 12; DisplayName.TextXAlignment = Enum.TextXAlignment.Left
...
UserName.Text = "@noxyorj"; UserName.TextColor3 = Theme.SubText; UserName.Font = Enum.Font.Gotham; UserName.TextSize = 11; UserName.TextXAlignment = Enum.TextXAlignment.Left
...
local gameName = "Kereste İşçisi 2"
pcall(function() gameName = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name end)

InfoText.Text = string.format(
    "Roblox User Name: <font color='rgb(180,180,180)'>umutk1mmm</font>\n" ..
    "Game Id: <font color='rgb(180,180,180)'>2471084</font>\n" ..
    ...
    gameName, game.PlaceId, execName
)
