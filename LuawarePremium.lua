--[[
    LUAWARE SCRIPT - THE TRUE HAWK FRAMEWORK
    YAPIMCI: NOXYORJ
    Durum: %100 Hatasız API, Kompakt Boyut, Sıvı Kaydırma Motoru
]]
...
function Luaware:Window(Config)
    ...
    function WindowObj:Tab(name)
        ...
        function Elements:AddProfile()
            ...
            local Avatar = Instance.new("ImageLabel", Page)
            ...
            local dName = Instance.new("TextLabel", Page)
            ...
            local uName = Instance.new("TextLabel", Page)
